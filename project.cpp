...
// Node Structure
// This struct represents a node in the Huffman tree, containing a character, its frequency, and pointers to left and right nodes.
struct Node
{
    char character;
    int frequency;
    ...
    // This overloaded operator enables the min-heap to sort nodes based on their frequency.
